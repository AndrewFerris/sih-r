...
#'
#' @example hier_str_dist(str_a = "ABCDE", str_b = "FGHIJ", format = "character")
#'
#' @export
NULL

hier_str_dist <- function(str_a, str_b, format){
  # Check whether the input format is a character or list
  if(format == "character"){
    ...
    z <- list(string_a, string_b, format, len_a, len_b, str_distance)

    # Return the string distance
    return(z)
  } else {
    stop("The format (class) of the strings has not been defined, please specify either character or list.")
  }
}
